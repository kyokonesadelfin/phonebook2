...
if(isset($_POST['submit'])){
	...
	if($contact_name == ''  || $phone ==''  ){
		...
		$sql = "INSERT INTO contactdetails(contact_name,designation	,phone,`address`) VALUES ('$contact_name','$designation','$phone', '$address')";
...
<div id= "main">
  ...
  <h1> Phone Book</h1>
<?php  include_once 'index.php';?></div>
  <form class="addusrbox" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
  <h1> Add User</h1>
 <label>Name<span style="color:red;">*</span></label> <input type="text" name ="contact_name" ><br>
